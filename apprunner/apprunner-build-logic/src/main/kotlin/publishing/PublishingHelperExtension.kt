...
constructor(objectFactory: ObjectFactory, project: Project) {
  ...
  /** Used to override the name of the GitHub repo in the apache organization. Defaults to the project ID. */
  val githubRepositoryName = objectFactory.property<String>()
  /** Used to override the project's SCM as it appears in published Maven poms. Default is derived from `githubRepositoryName`. */
