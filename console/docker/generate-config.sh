...
window.APP_CONFIG = {
  ...
  VITE_PROXY_AUTH: '${VITE_PROXY_AUTH}',
  VITE_PROXY_USERINFO_PATH: '${VITE_PROXY_USERINFO_PATH}',
  VITE_PROXY_USER_FIELDS: '${VITE_PROXY_USER_FIELDS}',
  VITE_PROXY_PRINCIPAL_FIELD: '${VITE_PROXY_PRINCIPAL_FIELD}'
};
EOF
